...
* @brief This is a class to store porperties of face.
*/
...
* @params _x x location of face
* @params _y y location of face
...
/**
* @brief This is the function to set x location of face.
* @params _x x location of face
*/
...
/**
* @brief This is the function to get x location of face.
...
/**
* @brief This is the function to set y location of face.
* @params _y y location of face
*/
...
/**
* @brief This is the function to get y location of face.
